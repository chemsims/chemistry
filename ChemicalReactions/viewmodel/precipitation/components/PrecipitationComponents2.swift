...
class PrecipitationComponents: ObservableObject {
    ...
    init(
        ...
        self.knownReactantPrep = KnownReactantPreparation.components(
            unknownReactantCoeff: reaction.unknownReactant.coeff,
            grid: grid,
            settings: settings,
            reactionProgressModel: rp,
    ...
    @Published private(set) var knownReactantPrep: ReactantPreparation

    @Published private(set) var unknownReactantPrep: ReactantPreparation? = nil

    @Published private(set) var extraUnknownReactantPrep: ReactantPreparation? = nil

    private(set) var initialReaction: InitialReaction? = nil
    ...
    private var currentReactantPrep: ReactantPreparation? {
        switch phase {
...
extension PrecipitationComponents {
    private func setKnownReactantComponents() {
        self.knownReactantPrep = PrecipitationComponents.KnownReactantPreparation.components(
            unknownReactantCoeff: reaction.unknownReactant.coeff,
            grid: grid,
            settings: settings,
    ...
    private func setUnknownReactantComponents() {
        self.unknownReactantPrep = PrecipitationComponents.UnknownReactantPreparation.components(
            unknownReactantCoeff: reaction.unknownReactant.coeff,
    ...
    private func setInitialReactionComponents() {
        ...
        self.initialReaction = PrecipitationComponents.InitialReaction(
            unknownReactantCoeff: reaction.unknownReactant.coeff,
            previous: unknownReactantPrep,
            endOfReaction: endOfInitialReaction,
            grid: grid
        )
    }
    ...
    private func setExtraUnknownReactantPrep() {
        ...
        self.extraUnknownReactantPrep = PrecipitationComponents.AddExtraUnknownReactant.components(
...
extension PrecipitationComponents.InitialReaction: R {
    func initialCoords(for molecule: PrecipitationComponents.Molecule) -> [GridCoordinate] {
        coords(for: molecule).coords(at: startOfReaction)
    }

    func finalCoords(for molecule: PrecipitationComponents.Molecule) -> [GridCoordinate] {
        coords(for: molecule).coords(at: endOfReaction)
    }
}
