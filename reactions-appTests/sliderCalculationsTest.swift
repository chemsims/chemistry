...
class SliderCalculationsTests: XCTestCase {

    func testSimpleSliderPositionAtCenter() {
        let model1 = SliderCalculations(minValuePosition: 0, maxValuePosition: 1, minValue: 0, maxValue: 1)
        testSlider(handlePosition: 0.5, value: 0.5, model: model1)

        let model2 = SliderCalculations(minValuePosition: 1, maxValuePosition: 2, minValue: 0, maxValue: 1)
        testSlider(handlePosition: 1.5, value: 0.5, model: model2)

        let model3 = SliderCalculations(minValuePosition: -1, maxValuePosition: 1, minValue: 0, maxValue: 1)
    ...
    func testSliderPositionOffCenter() {
        ...
        let model2 = SliderCalculations(minValuePosition: 1, maxValuePosition: 3, minValue: 0, maxValue: 1)
    ...
    func testSliderPositionForReverseAxis() {
        let model = SliderCalculations(minValuePosition: 1, maxValuePosition: 0, minValue: 0, maxValue: 1)
    ...
    func testSliderPositionForOffzeroValues() {
        let model = SliderCalculations(minValuePosition: 10, maxValuePosition: 20, minValue: 100, maxValue: 200)
        testSlider(handlePosition: 10, value: 100, model: model)
    }

    func testSliderPositionForNegativeValues() {
        let model = SliderCalculations(minValuePosition: 10, maxValuePosition: 20, minValue: -100, maxValue: -50)
        testSlider(handlePosition: 10, value: -100, model: model)
