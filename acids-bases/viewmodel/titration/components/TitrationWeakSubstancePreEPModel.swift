            ...
            initial: .init {
                ...
                case .hydrogen:
                    return BeakerMolecules(
                        coords: [],
                        color: RGB.hydrogen.color,
                        label: PrimaryIon.hydrogen.accessibilityLabel
                    )
                case .hydroxide:
                    return BeakerMolecules(
                        coords: [],
                        color: RGB.hydroxide.color,
                        label: PrimaryIon.hydroxide.accessibilityLabel
                    )
                case .secondaryIon:
                    return BeakerMolecules(
                        coords: [],
                        color: previous.substance.secondary.color,
                        label: previous.substance.accessibilityLabel(ofPart: .secondaryIon)
                    )
