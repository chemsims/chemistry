...
struct ConcentrationValueSlider: View {
    ...
    var body: some View {
        DualValueSlider(
            ...
            value1Label: "input for concentration of \(reactant) at start of reaction, molar",
            value2Label: "input for concentration of \(reactant) at end of reaction, molar",
            axis: settings.yAxis,
...
struct TimeValueSlider: View {
    ...
    var body: some View {
        DualValueSlider(
            ...
            value1Label: "input for start time of reaction in seconds",
            value2Label: "input for end time of reaction in seconds",
            axis: settings.xAxis,
